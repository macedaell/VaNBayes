...
nonspatial_SIR_bayesflow.ipynb: Python notebook that includes the implementation of Bayesflow
sim_study.R: The source file, which runs the simulation study 
