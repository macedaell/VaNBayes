...
original_parameters = function(configured_parameters){
  ...
  parameters[1] = boxcox_inv(configured_parameters[1],0.25)
...
configure_parameters = function(parameters){
  ...
  configured_parameters[1] = boxcox(parameters[1],0.25)
...
architectures = list(c(20, 10), c(100,25,20), c(100,20)) # 100,20
LRs = c(0.001, 0.001, 0.001)
