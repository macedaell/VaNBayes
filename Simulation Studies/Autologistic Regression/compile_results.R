...
pip_box <- function(p0,p1){
  ...
  legend("topright",c("MCMC","DNN"),fill=c("white","gray"),bty="n",cex=1.5)
}
...
pdf("sigma_medians.pdf")
 ...
 plot(s0_10,s1_10,xlab="MCMC",ylab="DNN",xlim=r,ylim=r)
 abline(0,1)
 plot(s0_20,s1_20,xlab="MCMC",ylab="DNN",xlim=r,ylim=r)
 abline(0,1)
dev.off()
